...
// Manejo del scroll para cambiar el color de la barra de navegación
    useEffect(() => { 
...
return ( 
    ...
    <AppBar 
        position="fixed" 
        sx={{ 
            backgroundColor: scrolled ? "#3B6BA5" : "transparent", 
            transition: "0.3s", 
        ...
        <Box sx={{ width: 250, p: 2 }}> 
            ...
            {sections.map((item) => ( 
                ...
                <ScrollLink 
                    ...
                    smooth={true} 
                    duration={500} 
                    style={{ width: "100%", color: "#333", paddingLeft: "10px" }} > 
